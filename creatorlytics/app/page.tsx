          ...
          <div className="lp-dpanel">
            ...
            <div className="lp-dpb">
              <div className="lp-aigrid">
                <div className="lp-aic"><div className="lp-aiico">⏰</div><div><div className="lp-ait">Waktu Terbaik Posting</div><div className="lp-aid">Selasa &amp; Kamis pukul 19:00–21:00 WIB menghasilkan ER 2.4× lebih tinggi dari rata-rata kontenmu.</div></div></div>
                <div className="lp-aic"><div className="lp-aiico">🎬</div><div><div className="lp-ait">Format Terpopuler di Akunmu</div><div className="lp-aid">Reels menghasilkan reach 68% lebih tinggi vs foto carousel bulan ini. Perbanyak Reels pendek.</div></div></div>
                <div className="lp-aic"><div className="lp-aiico">📈</div><div><div className="lp-ait">Topik yang Sedang Naik</div><div className="lp-aid">&quot;Tutorial editing&quot; dan &quot;Behind the scenes&quot; adalah 2 topik dengan engagement tertinggi — pertahankan.</div></div></div>
              </div>
