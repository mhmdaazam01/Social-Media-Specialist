          ...
          <table className="w-full border-collapse min-w-[1400px]">
            <thead className="sticky top-0 bg-cly-muted z-10">
              <tr>
                ...
                <th className="text-center text-cly-xs font-black text-cly-text-3 uppercase tracking-wider py-3 px-3 border-r border-cly-border w-[100px] bg-cly-muted">
                  Date
                </th>
                {accountFilter === 'all' && (
                  <th className="text-center text-cly-xs font-black text-cly-text-3 uppercase tracking-wider py-3 px-3 border-r border-cly-border w-[120px] bg-cly-muted">
                    Account
                  </th>
                )}
                ...
                <th className="text-center text-cly-xs font-black text-cly-text-3 uppercase tracking-wider py-3 px-3 border-r border-cly-border w-[90px] bg-cly-muted">
                  Reach
                </th>
                <th className="text-center text-cly-xs font-black text-cly-text-3 uppercase tracking-wider py-3 px-3 border-r border-cly-border w-[80px] bg-cly-muted">
                  Like
                </th>
                <th className="text-center text-cly-xs font-black text-cly-text-3 uppercase tracking-wider py-3 px-3 border-r border-cly-border w-[90px] bg-cly-muted">
                  Comment
                ...
                <th className="text-center text-cly-xs font-black text-cly-text-3 uppercase tracking-wider py-3 px-3 border-r border-cly-border w-[70px] bg-cly-muted">
                  ER
                </th>
              ...
              {loading ? (
                ...
                filteredPosts.map((post, idx) => {
                  ...
                  >
                    ...
                    {/* Impression */}
                    <td
                      className="py-2 px-3 text-center border-r border-cly-border cursor-text"
                    ...
                    >
                      {editingCell?.postId === post.id && editingCell?.field === 'impression' ? (
                        ...
                        <div className="h-7 flex items-center justify-center text-cly-sm text-cly-text-2">
                          {post.impression || 0}
                        </div>
                      )}
                    </td>
                    ...
                    {/* ER (Auto-calculated) */}
                    <td className="py-2 px-3 text-center border-r border-cly-border">
                      <div className="h-7 flex items-center justify-center text-cly-sm text-cly-text font-bold">
                        {er.toFixed(2)}%
                      </div>
                    </td>
